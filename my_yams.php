...
class Yams {
	...
	public static function displayHelp () {
		...
		'd3 la valeur de troisième dé', 'd4 la valeur de quatrième dé', 'd5 la valeur de cinquième dé', 'd6 la valeur de sixième dé', 'c la combinaison souhaitée', '', 'combinaison: paire, brelan, carre, yams, full, suite', 'EXEMPLE:', 'php my_yams.php 1 2 3 2 1 brelan_2', 'php my_yams.php 4 5 4 3 1 full_4_3', 'php my_yams.php 2 3 3 5 4 suite_6']) . "\n";
	}
